    ...
    fetch("/auth/session-info")
        ...
        .then(data => {
            if (data.loggedIn) {
                ...
                document.getElementById("mainLoginButton").style.display = "none"; // 메인 로그인 버튼 숨기기
                ...
                // 로그아웃 상태일 때
                //alert("로그아웃 상태입니다!");
                document.getElementById("loginModalButton").style.display = "block"; // 로그인 버튼 표시
                document.getElementById("myPageButtonContainer").style.display = "none"; // 마이페이지 버튼 숨기기기
